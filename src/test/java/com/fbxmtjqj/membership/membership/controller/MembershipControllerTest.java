...
import com.fbxmtjqj.membership.common.exception.GlobalExceptionHandler;
...
public class MembershipControllerTest {
    ...
    public void 멤버십상세조회실패_멤버십이존재하지않음() throws Exception {
        // given
        final String url = "/api/v1/memberships/-1";
        doThrow(new ServerException(ErrorCode.MEMBERSHIP_NOT_FOUND))
    ...
    public void 멤버십등록실패_MemberService에서에러Throw() throws Exception {
        // given
        final String url = "/api/v1/memberships";
        doThrow(new ServerException(ErrorCode.DUPLICATED_MEMBERSHIP_REGISTER))
